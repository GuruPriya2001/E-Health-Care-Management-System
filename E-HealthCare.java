...
");contact=scan.nextLong();bufferedWriter.write("Contact Number : "+contact);
 ...
 bufferedWriter.newLine();
 System.out.print("\nBlood Group : ");bg=scan.next();bufferedWriter.write("Blood Group :
"+bg);
 bufferedWriter.newLine();
 System.out.print("\nAny Major disease suffered earlier :
");disease=readString();bufferedWriter.write("Any Major disease suffered earlier : "+disease);
 bufferedWriter.newLine();
...
true)));
 ...
 System.out.print("\nDoctor appointed:");doctor=readString();out.println("Doctor
appointed: "+doctor);
 System.out.print("\nSymptoms : ");symptom=readString();out.println("Symptoms :
"+symptom);
 System.out.print("\nDiagnosis : "); diagnosis=readString();out.println("Diagnosis :
"+diagnosis);
 System.out.print("\nMedicines : ");medicine=readString(); out.println("Medicines :
"+medicine);
 System.out.print("\nAddmission Required? : ");
 addmission=readString();out.println("Addmission Required? : "+addmission);
 if(addmission.equals("Yes")||addmission.equals("Y"))
 {
 System.out.print("\nType of ward : ");ward=readString(); out.println("Type of ward :
"+ward);
 out.println("\n*************************************************************************\n");
...
|\n");
 ...
 System.out.print("\t\t\t\t\t| |\n");
 System.out.print("\t\t\t\t\t| |\n");
 System.out.print("\t\t\t\t\t| -Brought To You by GURU PRIYA
riyr\n");
...
_______________________________|\n");
 ...
 void info()
 {
 System.out.println("\n\nE-Health care management system is command-driven application
that helps to manage the record of the patient's as well as generate their hospital bills.");
...
System.out.print("\t\t\t\t__________________________________________________________
________________________________________________________________________\n");
 System.out.println("\t\t\t\t 1 >> Add New Patient Record | A new patient file can be
created by using this module.");
 System.out.println("\t\t\t\t 2 >> Add Diagnosis Information | Adding day-to-day
evaluation of the patient or the diagnosis report in the existing file.");

 System.out.println("\t\t\t\t 3 >> History of the Patient | Check the previous or existing
details of particular patient by using their file name.");
 System.out.println("\t\t\t\t 4 >> Bill of the patient | Generates the bill of the patient
with displaying the details.");
 System.out.println("\t\t\t\t 5 >> Help | Provide the help documentation.");
 System.out.println("\t\t\t\t 6 >> Exit | Exits the application.");
 pressAnyKeyToContinue();
 }
}
public class E-HealthCare
{
